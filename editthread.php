...
<span id="getbody" style="display:none;"><?phpecho $thread->posttext;?></span>
<div id="main_body">
				...
				<div class="panel panel-default" style="border-color:#c3c6ff;">
					<div class="panel-body">
						...
						<center>
							...
							<a href="/thread?id=<?phpecho $thread->id;?>"><button type="button" class="btn btn-default" id="cancel_btn">Cancel</button></a>
						</center>
					</div>
				</div>
			</td>
